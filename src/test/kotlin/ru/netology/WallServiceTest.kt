...
class WallServiceTest {
    ...
    fun update_postTrue() {
        ...
        val postNew2 = service.add(Post(id = 2, ownerId = 1, fromId = 1, createdBy = 99, date = 20220612, text = "Hello Motlin", replyOwnerId = 1, replyPostId = 1, friends_only = false, postType = PostType.post))
    ...
    fun update_postFalse() {
        ...
        //act
        val result = service.update(Post(id = 4, ownerId = 1, fromId = 1, createdBy = 99, date = 20220612, text = "Hello Potlin", replyOwnerId = 1, replyPostId = 1, friends_only = false, postType = PostType.post))
